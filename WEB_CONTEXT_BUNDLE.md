...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-820-erd-s-problem-820-4f1d0311-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-820"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-820-erd-s-problem-820-4f1d0311-v1",
      "problem_contract_sha256": "ff4fdd06fbd69df33793f2e858ee7638032036990419ac90928a88f0f0b8f9a1",
      "problem_id": "problem:um-ep-820-erd-s-problem-820-4f1d0311",
      "route_id": "route:um-ep-820-erd-s-problem-820-4f1d0311-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-820-erd-s-problem-820-4f1d0311-source-fidelity-01",
      "graph_id": "graph:um-ep-820-erd-s-problem-820-4f1d0311-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-820-erd-s-problem-820-4f1d0311-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-820-erd-s-problem-820-4f1d0311-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $H(n)$ be the smallest integer $l$ such that there exist $k<l$ with $(k^n-1,l^n-1)=1$. Is it true that $H(n)=3$ infinitely often? (That is, $(2^n-1,3^n-1)=1$ infinitely often?) Estimate $H(n)$. Is it true that there exists some constant $c>0$ such that, for all $\\epsilon>0$, $ H(n) > \\exp(n^{(c-\\epsilon)/\\log\\log n}) $ for infinitely many $n$ and $ H(n) < \\exp(n^{(c+\\epsilon)/\\log\\log n}) $ for all large enough $n$? Does a similar upper bound hold for the smallest $k$ such that $(k^n-1,2^n-1)=1$?"
          },
          "statement_sha256": "3cf17595b26491850d0db7233d1a3ae98cd2c9001591288682e4b2d39e3d5b93"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-820-erd-s-problem-820-4f1d0311-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-820-erd-s-problem-820-4f1d0311-root",
      "route_id": "route:um-ep-820-erd-s-problem-820-4f1d0311-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-820-5406f98ea3d3",
        "url": "https://www.unsolvedmath.com/problems/EP-820"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
